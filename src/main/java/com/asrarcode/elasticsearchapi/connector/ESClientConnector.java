package com.asrarcode.elasticsearchapi.connector;
...
import com.asrarcode.elasticsearchapi.utils.QueryBuilderUtils;
...
public class ESClientConnector {
    ...
    public boolean bulkInsertEmployees(List<USEmployee> employeeList) throws IOException {
